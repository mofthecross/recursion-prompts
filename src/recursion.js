...
var arraySum = function(array) {
  if(array.length === 0) {
    ...
    var begin = Array.isArray(array[0]) ? arraySum(array[0]) : array[0];
    return begin + arraySum(array.slice(1, array.length));
  }
};
...
var capitalizeFirst = function(array) {
  ...
  return !array.length ? [word] : [word].concat(capitalizeFirst(array));
};
...
var letterTally = function(str, obj) {
  obj = obj || {};
  str.charAt(0) in obj ?  obj[str.charAt(0)] = obj[str.charAt(0)] + 1 : obj[str.charAt(0)] = 1;
  return !str.length ? obj : letterTally(str.slice(1), obj);
};
